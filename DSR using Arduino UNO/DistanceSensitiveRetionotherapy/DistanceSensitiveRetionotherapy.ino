/** Project: Distance Sensitive Retinotherepy
  * Author: Jayanth Narasimha S
  * Requirememnt: Dr. Lakshana
*/
...
void setup()
{
  ...
  pinMode(buzzerPin, OUTPUT); // Sets the echoPin as an OUTPUT
...
void loop()
{
  ...
  if(distance < 64 || distance > 70)
  {
    // digitalWrite(buzzerPin, HIGH);
    analogWrite(buzzerPin, 25);    // Half Capacity of BUZZER SOUND.
  }
  else
  {
    // digitalWrite(buzzerPin, LOW);
    analogWrite(buzzerPin, 0);    // Half Capacity of BUZZER SOUND.
  }
